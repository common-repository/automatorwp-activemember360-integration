...
class AutomatorWP_ActiveMember360_User_Tag extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add tag to user', 'automatorwp-activemember360-integration' ),
            'select_option'     => __( 'Add <strong>tag</strong> to user', 'automatorwp-activemember360-integration' ),
            /* translators: %1$s: Tag name. */
            'edit_label'        => sprintf( __( 'Add %1$s to user', 'automatorwp-activemember360-integration' ), '{tag}' ),
            /* translators: %1$s: Tag name. */
            'log_label'         => sprintf( __( 'Add %1$s to user', 'automatorwp-activemember360-integration' ), '{tag}' ),
            'options'           => array(
                'tag' => array(
                    'from' => 'tag',
                    'fields' => array(
    ...
    public function tags_options_cb() {
        ...
        $options = array(
            'any' => __( 'all tags', 'automatorwp-activemember360-integration' ),
        );
