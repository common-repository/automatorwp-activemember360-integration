...
class AutomatorWP_ActiveMember360_Contact_Tag extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User has tag', 'automatorwp-activemember360-integration' ),
            'select_option'     => __( 'User has <strong>tag</strong>', 'automatorwp-activemember360-integration' ),
            /* translators: %1$s: Tag name. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User has %1$s %2$s time(s)', 'automatorwp-activemember360-integration' ), '{tag}', '{times}' ),
            /* translators: %1$s: Tag name. */
            'log_label'         => sprintf( __( 'User has %1$s', 'automatorwp-activemember360-integration' ), '{tag}' ),
            'action'            => 'init',
            ...
            'options'           => array(
                'tag' => array(
                    ...
                    'fields' => array(
                        'tag' => array(
                            'name' => __( 'Tag:', 'automatorwp-activemember360-integration' ),
                            'type' => 'select',
    ...
    public function tags_options_cb() {
        ...
        $options = array(
            'any' => __( 'any tag', 'automatorwp-activemember360-integration' ),
        );
