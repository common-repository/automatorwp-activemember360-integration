...
Tags: activemember360, automatorwp, automator, automation, activecampaign, active, member
...
Connect AutomatorWP with ActiveMember360
...
[ActiveMember360](https://activemember360.com/ "ActiveMember360") is a WordPress member management and membership plugin exclusively built for ActiveCampaign.

This plugin automatically connects [AutomatorWP](https://wordpress.org/plugins/automatorwp/ "AutomatorWP") with ActiveMember360 adding new triggers that you can use to connect with other plugins and automate workflows letting you save time and get focused on your most important work.

= Triggers =

* User has any/specific tag.

= Actions =

* Add all/specific tag to user.

= Pro version =

[Pro version](https://automatorwp.com/add-ons/activemember360/ "AutomatorWP - ActiveMember360") available that let's you expand the integration between AutomatorWP and ActiveMember360 bringing you more ways to automatize your ActiveCampaign connection.
...
* [WishList Member](https://wordpress.org/plugins/automatorwp-wishlist-member-integration/)
